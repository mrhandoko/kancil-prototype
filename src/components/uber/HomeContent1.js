      ...
      <div className="container" style={{margin: '25px 0'}}>
        <div className="row">
          <div className="col-sm-12 col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-1">
            ...
            <br />
            <span className="highlighted1">• Kartu Pertamina senilai 1 juta (fuel card)</span>
            <br />
            <span className="highlighted1">• Cashback 20% atau 100 ribu jika berinvestasi dengan Kelola (<a href="#cashback" data-modal-open>Information</a>)</span>
            <br />
            <br />
            <p>
            ...
            <ul>
              <li>Cashback hanya berlaku bagi investasi aktif di dalam aplikasi <a href="http://www.kelolaapp.com">Kelola</a>.</li>
              <li>Cashback hanya dapat ditarik setelah investasi berjalan minimal 1 bulan; kurang dari 1 bulan cashback tidak bisa ditarik:
                <ul>
                  Contoh:
                  <li>Bulan 1 seseorang berinvestasi sebesar 300 ribu Rupiah</li>
                  <ul><li>Jumlah dana dikelola = 300 ribu + (300 ribu x 20%) = 360 ribu Rupiah</li>
                    <li>Investasi ditarik sebelum 1 bulan : 300 ribu Rupiah</li>
                    <li>Investasi ditarik setelah 1 bulan : 360 ribu Rupiah</li></ul>
                </ul>
              </li>
            </ul>
            <p />
