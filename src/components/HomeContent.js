    ...
    <section className="parallax parallax-1">
      <div className="row">
        <div className="col-sm-6 col-md-6 col-lg-6 col-sm-offset-3 text-center" style={{padding: '0px 15px'}}>
          <Link to="phone"><img src="img/phone.png" width={190} className="hidden-sm" />
            <img src="img/phone.png" className="hidden-lg hidden-md" /></Link>
        </div>
      </div>
    </section>
  </div>
